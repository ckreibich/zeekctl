...
*LibDirInternal* (string, default "$\{ZeekBase}/lib/python/zeekctl")
...
ZeekControl searches ``<prefix>/lib/python/zeekctl/plugins``; additional directories
...
the ``<prefix>/lib/python/zeekctl/plugins`` directory.
